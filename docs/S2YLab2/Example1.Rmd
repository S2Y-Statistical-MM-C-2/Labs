...
The value of this test statistic is \(1.5358 − 1.7601 = −0.2243\). The standardised test statistic under the assumption that \(H_0\) is true and its approximate distribution are:
...
The test we are actually running here is a Welch test as we are comparing two independent samples from normal distributions without assuming they have equal variances. In R this is automatically chosen within the `t.test()` function:
