...
2. Fit a multiple linear regression model to the data in order to predict % body fat from triceps skinfold thickness and midarm circumference. 
`r hide("Solution")`
```{r}
