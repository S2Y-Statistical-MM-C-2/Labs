...
`r hide("Solution - Remove for lab")`
...
rows corresponding to each of the 50 US states, and $p = 2$ columns corresponding to the model parameters $\beta_0$ and $\beta_1$. More generally this is written as
